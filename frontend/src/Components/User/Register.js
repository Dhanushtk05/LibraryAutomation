    ...
    return (
       <div className='registerpage'>
        <div className="row wrapper">
            ...
            <div className="form-group">
                <label htmlFor="email_field">Register Number</label>
                <input name='regno'  onChange={onChange} type="name" id="register_field" placeholder='Register Number' className="form-control" />
            </div>
                ...
                <div className='d-flex align-items-center'id='avload'>
                    <div>
